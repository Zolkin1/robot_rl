...
ROBOT_ASSETS_AMBER = "/home/s-ritwik/src/robot_rl/robot_assets/amber5_simple_urdf/amber"

AMBER_CONFIG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"{ROBOT_ASSETS_AMBER}/Amber_wc2.usd",
    ...
    actuators={
        "base_to_torso_act": ImplicitActuatorCfg(
            joint_names_expr=["base_link_to_torso"],
