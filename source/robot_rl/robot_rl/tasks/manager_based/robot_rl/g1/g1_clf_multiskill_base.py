...
class G1MultiSkillCommandsCfg(G1ClfTrackingCommandCfg):
    traj_ref = BatchedMultiSkillCommandCfg(
        ...
        contact_gate_window_frac=0.001, #None, #0.2,   # NOTE: Making this too big (like 0.2) can lead to spurious detections.
        hold_on_late_contact=False, #True, #False, #True,  # TODO: need to consider that for False, the reference frame is
